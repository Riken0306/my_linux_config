...
M.setup = function()
  ...
  vim.diagnostic.config({
    ...
    signs = {
      -- Custom text for diagnostic signs
      text = {
      ...
      -- Highlight lines based on diagnostic severity
      linehl = {
        [vim.diagnostic.severity.ERROR] = 'ErrorMsg',
        -- You can add line highlights for other severities if needed
      },
      -- Highlight line numbers based on diagnostic severity
      numhl = {
        [vim.diagnostic.severity.WARN] = 'WarningMsg',
        -- You can add number highlights for other severities if needed
      },
    },
